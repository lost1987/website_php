<?php
    ...
    use pms\model\Article_M;
    use pms\model\ArticleCategory_M;
    use utils\Page;
    use utils\Tools;
    use utils\Upload;
    ...
    class Article extends AdminController
    {
        ...
        function lists()
        {
            ...
            $flags = $this->config->pms['article_flags'];
            ...
            if ( Cookie::instance()->userdata( 'is_administrator' ) ) {
                ...
                if ( !empty( $session_p ) ) {
                    ...
                    foreach ( $session_p as $p ) {
                        if ( $p['module_id'] == ModuleDictionary::ROOT_MODULE_ARTICLES ) {
        ...
        function add()
        {
            ...
            $this->output_data['flags'] = $this->config->pms['article_flags'];
