<?php
    ...
    /**
     * 钻石获取
     * Class DatasDiamondGet
     * @package gms\model
     */
    class DatasDiamondGet_M extends GameModel
    {
        ...
        function listsByDays( $start = null , $count = null )
        {
            ...
            $sql = "SELECT
                DISTINCT(COUNT(uid)) AS getUserNum,
                COUNT(uid) AS getUserCount,
                SUM(tool) AS getTotal,
