<?php
    ...
    class TipOff_M extends XfModel
    {
        ...
        function lists( $start = null , $count = null )
        {
            ...
            $sql = "SELECT a.*,b.reporter_name,b.assign_to,b.result,b.handler_type,b.handle_time  FROM xf_index_tipoff a   LEFT JOIN xf_index_handleresult b ON a.handler_id = b.id  {$this->_condition}  ORDER BY a.create_at DESC $limit";
            $this->db->execute( $sql );
            $this->_condition = '';
        ...
        function num_rows()
        {
            $sql = "SELECT COUNT(*) as num FROM xf_index_tipoff a  LEFT JOIN xf_index_handleresult b ON a.handler_id = b.id {$this->_condition}";
            $this->db->execute( $sql );
            $this->_condition = '';
        ...
        function read( $id )
        {
            $sql = "SELECT * FROM xf_index_tipoff WHERE id  = ?";
