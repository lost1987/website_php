            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (response.error == 0) {
                        ...
                        sOut += '<tr><th>报名费用:</th><td>'+response.signup_price.coin_amount+'金币,'+response.signup_price.ticket_amount+'门票,'+response.signup_price.coupon_amount+'奖券,'+response.signup_price.diamond_amount+'钻石</td></tr>';
