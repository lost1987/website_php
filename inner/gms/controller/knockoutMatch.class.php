    ...
    class KnockoutMatch extends AdminController
    {
        ...
        function verifyMatch()
        {
            ...
            if ( $verify == 0 ) {
                ...
                $signup_price['coin_amount'] = $fields['coin_amount'];
                $signup_price['ticket_amount'] = $fields['ticket_amount'];
                $signup_price['coupon_amount'] = $fields['coupon_amount'];
                $signup_price['diamond_amount'] = $fields['diamond_amount'];
                unset( $fields['coin_amount'] , $fields['ticket_amount'],$fields['coupon_amount'] ,$fields['diamond_amount']  );
