<?php
    ...
    class Platform
    {
        ...
        const RECHARGE_CHINA_MOBILE = 13;
        ...
        function getRechargePlatforms()
        {
            return array(
                ...
                self::RECHARGE_CHINA_MOBILE => '中国移动客户端'
            );
        }
        ...
        function getRechargeType( $orderNo )
        {
            ...
            switch ($orderNoPrefix) {
                ...
                case 'cm':
                    $rechargeType = self::RECHARGE_CHINA_MOBILE;
                    break;
            }
