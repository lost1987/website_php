...
class PayAliPay extends BasePay
{
     ...
     * @return mixed
     */
    function pay($amount,$area_id,$game_id,Array $remark = null)
    {
        ...
        if(false == $this->save_order($remark['uid'],$order_id,$amount,$remark['pay_type'],$remark['uid'],$area_id,$game_id))
        ...
        $params = array(
            ...
            "extra_common_param" => $game_id.'|'.$area_id
        );
