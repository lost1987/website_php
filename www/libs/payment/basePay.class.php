...
abstract class BasePay extends Controller{
     ...
     * @return mixed
     */
    abstract function pay($amount,$area_id, $game_id,Array $remark=null);
     ...
     */
    protected function save_order($uid,$order_no,$money,$pay_type,$pay_for_id,$area_id,$game_id){

        if($pay_type == 2) {//手机卡支付
            $pay_amount = $this->config->common['pay_amount_ratio_mobile'];
        }else{
            $pay_amount = $this->config->common['pay_amount_ratio'];
        }
