...
class AlipayNotify
{
    ...
    function getSignVeryfy($para_temp, $sign)
    {
        ...
        switch (strtoupper(trim($this->alipay_config['sign_type']))) {
            case "MD5" :
                ...
                break;
            case "RSA" :
                $isSgin = $this->rsaVerify($prestr, $sign, $this->alipay_config['key']);
                break;
            default :
                $isSgin = false;
        }
    ...
    {
        $rsa_file = BASE_PATH.'/libs/payment/alipay_private.pem';
        $public_key = file_get_contents($rsa_file);
    ...
    function rsaVerify($prestr, $sign)
    {
        ...
        $rsa_file = BASE_PATH.'/libs/payment/alipay_public.pem';
        $cert = file_get_contents($rsa_file);
        $pkeyid = openssl_get_publickey($cert);
        if ($pkeyid) {
